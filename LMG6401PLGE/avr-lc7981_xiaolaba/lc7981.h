...
#define LCD_CTRL_E    2
#define LCD_CTRL_CS   3
#define LCD_CTRL_RST  4
...
#define lcd_rs_instruction() (LCD_CTRL_PORT |= (1<<LCD_CTRL_RS));
#define lcd_rs_data() (LCD_CTRL_PORT &= ~(1<<LCD_CTRL_RS));


//#define lcd_rw_high() (LCD_CTRL_PORT |= (1<<LCD_CTRL_RW));
//#define lcd_rw_low() (LCD_CTRL_PORT &= ~(1<<LCD_CTRL_RW));
#define lcd_rw_read() (LCD_CTRL_PORT |= (1<<LCD_CTRL_RW));
#define lcd_rw_write() (LCD_CTRL_PORT &= ~(1<<LCD_CTRL_RW));
